...
public enum ErrorCode {
    ...
    SLOT_TIME_PASSED(400, "Selected time slot has already passed", HttpStatus.BAD_REQUEST),
    ...
    PAYMENT_IN_PROGRESS(409, "A payment request is already in progress. Please complete it before retrying", HttpStatus.CONFLICT),
